...
interface IClooverRaffleGetters {
    ...
    function nftInfo() external view returns(IERC721 nftContractAddress, uint256 nftId);
...
interface IClooverRaffle is IClooverRaffleGetters {
    ...
    function purchaseTicketsWithPermit(uint16 nbOfTickets, ClooverRaffleTypes.PermitDataParams calldata permitData) external;
