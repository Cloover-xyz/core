...
interface IClooverRaffleFactory is IClooverRaffleFactoryGetters, IClooverRaffleFactorySetters {
    ...
    function createNewRaffle(ClooverRaffleTypes.CreateRaffleParams memory params) external payable returns(ClooverRaffle newClooverRaffle);
    
    /// @notice call by batch draw() for each raffleContract passed in params
