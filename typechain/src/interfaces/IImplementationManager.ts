...
export interface IImplementationManagerInterface extends utils.Interface {
  functions: {
...
export interface IImplementationManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IImplementationManagerInterface;
