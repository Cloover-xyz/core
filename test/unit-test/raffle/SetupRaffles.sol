...
contract SetupRaffles is Test, SetupUsers {
    ...
    function setUp() public virtual override{
        ...
        RaffleDataTypes.InitRaffleParams memory ethRaffleData = RaffleDataTypes.InitRaffleParams(
            implementationManager,
            mockERC20,
            mockERC721,
            alice,
        ...
        tokenRaffleInsuranceCost = minTicketSalesInsurance.calculateInsuranceCost(ticketPrice, INSURANCE_SALES_PERCENTAGE);
        mockERC20.transfer(address(tokenRaffleWithInsurance), tokenRaffleInsuranceCost);
        ...
        ethRaffleInsuranceCost = minTicketSalesInsurance.calculateInsuranceCost(ticketPrice, INSURANCE_SALES_PERCENTAGE);
        ethRaffleWithInsurance.initialize{value:ethRaffleInsuranceCost}(ethRaffleWithInsuranceData);
    }
